...
def list_knowledge_files():
    repo_path = Path('data/raw/vllm-0.10.1')
...
def index(python_corpus, markdown_corpus):
    ...
    # remove codebase noise words
    code_stopwords = [
        "def", "class", "return", "self", "import", "from", "as", 
        "none", "true", "false", "if", "elif", "else", "for", "in", 
        "while", "try", "except", "with", "pass", "args", "kwargs"
    ]
